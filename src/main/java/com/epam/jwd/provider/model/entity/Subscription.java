...
public class Subscription extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(userId, that.userId) && Objects.equals(tariffId, that.tariffId) && Objects.equals(startDate, that.startDate) && Objects.equals(endDate, that.endDate) && Objects.equals(price, that.price) && Objects.equals(tariffName, that.tariffName) && Objects.equals(tariffDescription, that.tariffDescription) && status == that.status && Objects.equals(addressId, that.addressId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(userId, tariffId, startDate, endDate, price, tariffName, tariffDescription, status, addressId);
    }
